    ...
    <div class="text-center">
      <v-dialog v-model="dialog" width="500">
        ...
        <v-card>
          ...
          <v-card-text>
            I confirm that I want to delete my account, which will cancel my
            access to this network and delete all my posts and comments.
          </v-card-text>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="warning" text @click="goBack">Cancel</v-btn>
